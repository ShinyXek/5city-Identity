...
RegisterNUICallback('register', function(data, cb)
	...
	if reason == "" then
		...
		EnableGui(false)
		Citizen.Wait(500)
		TriggerServerEvent('csgocase')
		TriggerEvent('raid_clothes:openmenu', myIdentifiers.id)
		exports.dopeNotify:SendNotification({					
		text = '<b><i class="fas fa-bell"></i> POWIADOMIENIE</span></b></br><span style="color: #a9a29f;">Za 2 Minuty Otworzy ci sie Menu Wyboru <span style="color: #ffffff;">CIUSZKOW!',
		type = "info",
		timeout = 10000,
		layout = "topLeft"
	})
		...
		Citizen.Wait(120000)
		TriggerEvent('raid_clothes:openmenu2', myIdentifiers.id)
